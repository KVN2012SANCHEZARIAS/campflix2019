...
class Browse extends CI_Controller {
	...
	function search($search_key = '')
	{
		...
		$page_data['page_title']	=	'Resultados de Búsqueda';
	...
	function movie($genre_id = '', $offset = '')
	{
		...
		$page_data['page_title']	=	'Ver Película';
	...
	function youraccount()
	{
		...
		$page_data['page_title']	=	'Mi Cuenta';
		$this->load->view('frontend/index', $page_data);
	}
	...
	function switchprofile()
	{
		...
		$page_data['page_title']		=	'Cuentas de Usuario';
	...
	function manageprofile()
	{
		...
		$page_data['page_title']		=	'Administrar Perfiles';
		$page_data['current_plan_id']	=	$this->crud_model->get_current_plan_id();
		$this->load->view('frontend/index', $page_data);
