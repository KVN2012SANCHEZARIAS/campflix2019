	...
	<div class="container" style=" width: 100%;">
		<div class="navbar-header">
			<a href="<?php echo base_url();?>index.php?browse/home" class="navbar-brand">
				<img src="<?php echo base_url();?>/assets/global/logo2.png" style=" height: 32px;margin-right: 50px;" />
			</a>
		...
		<div class="navbar-collapse collapse" id="navbar-main">
			<ul class="nav navbar-nav">
				<!-- MOVIES GENRE WISE-->
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="" style="color: #FFFFFF; font-size:16px;font-weight: bold;">
						Películas <span class="caret" style="color:#e50914;"></span>
					</a>
				...
				<li class="dropdown">
					<a class="dropdown-toggle" data-toggle="dropdown" href="" style="color: #FFFFFF; font-size: 16px; font-weight: bold;">
						Eventos <span class="caret" style="color:#e50914;"></span>
					</a>
					<ul class="dropdown-menu" aria-labelledby="themes">
						<?php
							$genres		=	$this->crud_model->get_genres();
				...
				<!-- MY LIST -->
				<li>
					<a href="<?php echo base_url();?>index.php?browse/mylist"><b>Mi Lista</b></a>
				</li>
			</ul>
			...
			<ul class="nav navbar-nav navbar-right">
				<li class="dropdown">
					...
					<ul class="dropdown-menu" aria-labelledby="themes">
						...
						<?php endif;?>
						<li class="divider"></li>
						<li><a href="<?php echo base_url();?>index.php?browse/manageprofile">Administrar Perfiles</a></li>
						<li class="divider"></li>
