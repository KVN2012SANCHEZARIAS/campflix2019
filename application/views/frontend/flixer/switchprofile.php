...
<!-- TOP LANDING SECTION -->
<div style="height:200vh;width:100%; background-color: #141414;">
	<!-- logo -->
	<div style="float: left;">
		<a href="<?php echo base_url();?>">
		<img src="<?php echo base_url();?>/assets/global/logo2.png" style="margin: 18px 40px; height: 35px;" />
		</a>
	</div>
	<div style="clear: both; text-align: center; padding-top: 100px;">
		<h1>¿A qué equipo pertenece?</h1>
		...
		<br>
		<a href="<?php echo base_url();?>index.php?browse/manageprofile" class="profile_manage">ADMINISTRAR EQUIPOS</a><br><br><br><br><br>
	</div>
</div>